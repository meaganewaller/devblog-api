...
RSpec.describe "Api::V1::Categories", type: :request do
  describe "GET /api/v1/categories" do
    ...
    context "when published_only flag not set" do
      it "responds with all categories, even without published posts" do
        categories = create_list(:category, 3)
        create(:post, category: categories[1], published: true)

        get "/api/v1/categories", params: {published_only: false}
