...
ActiveRecord::Schema[7.0].define(version: 20_231_018_001_308) do
  ...
  create_table 'reactions', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[session_id kind post_id], name: 'index_reactions_on_session_id_and_kind_and_post_id', unique: true
  end
  ...
  create_table 'views', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[viewable_slug viewable_type session_id],
            name: 'index_views_on_viewable_slug_and_viewable_type_and_session_id', unique: true
    t.index %w[viewable_slug viewable_type], name: 'index_views_on_viewable_slug_and_viewable_type'
  end
